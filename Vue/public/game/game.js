...
const background = new Sprite({
  ...
  imageSrc: "./game/assets/SpaceBackground.png",
  width: canvas.width,
  height: canvas.height,
});
...
const paddle1 = new paddle({
  ...
  imageSrc: "./game/assets/Paddle1.png",
  GoalSoundSrc: "./game/assets/Siuu.mp3",
  GoalAnimSrc: "./game/assets/nyancat-removebg-preview.png",
  GoalAnimFrame: 9,
});
...
const paddle2 = new paddle({
  ...
  width: parseInt(canvas.width / 34, 10),
  height: parseInt(canvas.height / 3.5, 10),
  imageSrc: "./game/assets/Paddle2.png",
  GoalSoundSrc: "./game/assets/Marex.wav",
  GoalAnimSrc: "./game/assets/horny-jail-bonk.png",
  GoalAnimFrame: 6,
});
...
const ballon = new ball({
  ...
  imageSrc: "./game/assets/Balls.png",
  speed: 4,
  framesMax: 10,
});
