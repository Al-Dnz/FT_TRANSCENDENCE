          ...
          <div class="mt-8 flex justify-center">
            <div class="w-full md:w-2/4 p-4">
              ...
              <div class="flex justify-center mt-4">
                <a
                  @click="log()"
                  class="flex items-center button rounded focus:ring-0 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed px-4 py-1 text-white bg-gradient-to-r from-blue-500 to-green-500 shadow-sm hover:from-blue-600 hover:to-green-600"
                >
                  <svg
                    class="h-8 w-8"
                    fill="#ffffff"
...
export default defineComponent({
  ...
  methods: {
    log() {
      ...
      //ALEX API
      // location.href = "https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-9a48a2df50ca211811249087b5d0c905f5a25caa967bb65ea5840f6e8e11e41a&redirect_uri=http%3A%2F%2Flocalhost%3A8000%2Fapp%2Fcallback&response_type=code";
